OCB_FLAGS = -use-ocamlfind -cflag -thread -cflag -linkpkg \
  -pkg unix -pkg yojson -pkg xml-light -pkg str \
	-I src -I src/util -I src/input -I src/logic -I src/proof -I src/rewriting \
	-I src/termination -pkg z3 -cflag -thread

OCB = ocamlbuild -tag thread $(OCB_FLAGS)
OCB_NATIVE = ocamlbuild -tag thread $(OCB_FLAGS)
